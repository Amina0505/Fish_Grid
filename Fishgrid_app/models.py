...
class Product(models.Model):
    ...
    user=models.ForeignKey(shopRegistration,on_delete=models.CASCADE,null=True)
    shop=models.ForeignKey(User,on_delete=models.CASCADE,null=True)
